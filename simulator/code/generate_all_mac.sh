...
echo "\t\$(LD) \$(LD_FLAGS) \$(OBJS) -framework GLUT -framework OpenGL -L../libs -lGLEW -L../libs -lglfw3 -ldl -L/opt/X11/lib -lXi -lXrandr -lXxf86vm -lXinerama -lXcursor -lrt -lm -pthread -lfreetype -L../libs -lAntTweakBar -o out/cs467"
echo ""
