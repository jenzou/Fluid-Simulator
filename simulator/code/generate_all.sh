...
echo "\t\$(LD) \$(LD_FLAGS) \$(OBJS) -lglut -lGLEW -L../libs -lglfw3 -lGLU -lGL -lX11 -ldl -lXi -lXrandr -lXxf86vm -lXinerama -lXcursor -lrt -lm -pthread -Wl,-rpath=../libs -lfreetype -lAntTweakBar -o out/cs467"
echo ""
